<?php
    ...
    function lobo_clean_string( $string ) {
        $bad = array( "content-type", "bcc:", "to:", "cc:", "href" );
        return str_replace( $bad, "", $string );
    }

    require( lobo_wp_path() );
    ...
    if( isset( $_POST['email'] ))  {
        ...
        $email_message .= "Name: " . lobo_clean_string( $name ) . "\n";
        $email_message .= "Email: " . lobo_clean_string( $email ) . "\n";
        $email_message .= "Message: " . lobo_clean_string( $message );
