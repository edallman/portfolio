(function ($) {
    ...
    Galleria.addTheme({
        ...
        if( $("body").hasClass("project-size-dynamic") ){
            this.append({
                'stage' : [b._closeButton, b._fitContentButton, b._contentArea, b._titleArea, b._projectInfo]
            });
        //in other case, the fit to area button is not added
        }else{
            this.append({
                'stage' : [b._closeButton, b._contentArea, b._titleArea, b._projectInfo]
            });
        }
        ...
        xy.append('<i class="fa fa-angle-left"><span class="galleria-control">' + $('.galleria-btn-labels .gal-prev').eq(0).text() + '</span></i>');
        xx.append('<i class="fa fa-angle-right"><span class="galleria-control">' + $('.galleria-btn-labels .gal-next').eq(0).text() + '</span></i>');
        ...
        $(".galleria-thumbnails-container").hoverIntent(function(){ c.click(); });
